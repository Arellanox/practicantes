...
<div class="row" id="paq">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-auto">
                        <input type="radio" class="btn-check" name="selectPaquete" id="check-agregar" value="1" checked
                            autocomplete="off">
                        <label class="btn btn-outline-success" for="check-agregar"><i class="bi bi-list"></i> Agregar
                            contenido</label>
                    </div>
                    <div class="col-auto d-flex align-items-center d-flex justify-content-center">
                        <input type="radio" class="btn-check" name="selectPaquete" id="check-editar" value="2"
                            autocomplete="off">
                        <label class="btn btn-outline-success" for="check-editar"><i class="bi bi-list"></i> Editar
                            paquete</label>
                    </div>
                </div>
    ...
    <div class="card col-9 pt-3" style="margin-bottom:5px;">
        <div class="col-12 d-flex align-items-center d-flex justify-content-center">
            ...
            <button type="button" class="btn btn-hover me-2" style="margin-bottom:4px" id="guardar-contenido-paquete"
                data-bs-toggle="modal" data-bs-target="#modalVistaPaquete">
                <i class=" bi bi-tablet-landscape"></i> Excel
            </button>
        </div>
