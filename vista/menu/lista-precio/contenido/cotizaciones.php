    ...
    <div class="card col-9 pt-3" style="margin-bottom:5px;">
        ...
        <div class="mx-2 mb-2">
            <div class="row" id="datosUsuarioCotizacion">
                ...
                <!-- <div class="col-6">
                    <p style="text-align: center;">Observaciones: </p> <span>Lorem, ipsum dolor sit amet consectetur
                        adipisicing elit. Eius soluta
                        laudantium ex unde laboriosam, quam nostrum sint quaerat, reiciendis rerum explicabo quis ab qui
                        dignissimos quo provident adipisci esse! Doloremque.</span>
                </div> -->
            </div>
        </div>
